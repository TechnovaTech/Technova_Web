...
<script>
  ...
  <title>Asiaze News App - Project Detail</title>
          ...
          <div class="col-12 text-center">
            ...
            <div class="mb-4">
              <svg width="60" height="60" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="mx-auto">
                <path d="M4 6h16v2H4zm0 5h16v2H4zm0 5h16v2H4z" fill="#E11D48"/>
                <circle cx="12" cy="12" r="10" stroke="#E11D48" stroke-width="2" fill="none"/>
              </svg>
            </div>
            
            <!-- Heading -->
            <h1 class="text-4xl sm:text-5xl font-bold text-white mb-4">Asiaze News App</h1>
            
            <!-- Subtitle -->
            <h2 class="text-2xl sm:text-3xl text-red-600 mb-6">Stay informed with latest news and updates</h2>
            ...
            <div class="mx-auto" style="max-width: 800px;">
              <p class="text-center text-lg text-gray-300 leading-relaxed mb-0">
                A comprehensive news application delivering real-time updates, personalized content, and breaking news from trusted sources across multiple categories.
              </p>
            </div>
          </div>
        </div>
          ...
          <div class="relative w-full h-80 sm:h-96 md:h-[34rem] mb-6 overflow-hidden">
            <div class="absolute inset-0 flex items-center justify-center">
              <div id="gallery-container" class="flex items-center justify-center h-full transition-transform duration-500 ease-in-out" style="transform: translateX(0px); width: max-content;">
                <img src="uploads/images/n1.png" class="gallery-image w-72 h-80 sm:w-80 sm:h-96 md:w-96 md:h-[30rem] object-contain rounded-lg mx-2 sm:mx-3 md:mx-4 opacity-60 blur-sm transition-all duration-500" alt="Asiaze News Screen 1">
                <img src="uploads/images/n2.png" class="gallery-image w-80 h-96 sm:w-96 sm:h-[30rem] md:w-[30rem] md:h-[32rem] object-contain rounded-lg mx-2 sm:mx-3 md:mx-4 opacity-100 blur-0 scale-110 z-10 transition-all duration-500" alt="Asiaze News Screen 2">
                <img src="uploads/images/n3.png" class="gallery-image w-72 h-80 sm:w-80 sm:h-96 md:w-96 md:h-[30rem] object-contain rounded-lg mx-2 sm:mx-3 md:mx-4 opacity-60 blur-sm transition-all duration-500" alt="Asiaze News Screen 3">
                <img src="uploads/images/n4.png" class="gallery-image w-72 h-80 sm:w-80 sm:h-96 md:w-96 md:h-[30rem] object-contain rounded-lg mx-2 sm:mx-3 md:mx-4 opacity-60 blur-sm transition-all duration-500" alt="Asiaze News Screen 4">
                <img src="uploads/images/n5.png" class="gallery-image w-72 h-80 sm:w-80 sm:h-96 md:w-96 md:h-[30rem] object-contain rounded-lg mx-2 sm:mx-3 md:mx-4 opacity-60 blur-sm transition-all duration-500" alt="Asiaze News Screen 5">
                <img src="uploads/images/n6.png" class="gallery-image w-72 h-80 sm:w-80 sm:h-96 md:w-96 md:h-[30rem] object-contain rounded-lg mx-2 sm:mx-3 md:mx-4 opacity-60 blur-sm transition-all duration-500" alt="Asiaze News Screen 6">
                <img src="uploads/images/n8.png" class="gallery-image w-72 h-80 sm:w-80 sm:h-96 md:w-96 md:h-[30rem] object-contain rounded-lg mx-2 sm:mx-3 md:mx-4 opacity-60 blur-sm transition-all duration-500" alt="Asiaze News Screen 8">
              </div>
            </div>
        ...
        <div class="max-w-6xl mx-auto">
          <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div class="bg-gray-900/50 p-6 rounded-lg border border-red-500/20">
              <h3 class="text-xl font-bold text-red-600 mb-4">Real-time Updates</h3>
              <p class="text-gray-300">Ensuring instant delivery of breaking news and live updates while maintaining app performance and battery efficiency.</p>
            </div>
            <div class="bg-gray-900/50 p-6 rounded-lg border border-red-500/20">
              <h3 class="text-xl font-bold text-red-600 mb-4">Content Curation</h3>
              <p class="text-gray-300">Implementing AI-powered algorithms to filter fake news and deliver credible, relevant content to users.</p>
            </div>
            <div class="bg-gray-900/50 p-6 rounded-lg border border-red-500/20">
              <h3 class="text-xl font-bold text-red-600 mb-4">Personalization</h3>
              <p class="text-gray-300">Creating personalized news feeds based on user preferences, reading habits, and location without compromising privacy.</p>
            </div>
            <div class="bg-gray-900/50 p-6 rounded-lg border border-red-500/20">
              <h3 class="text-xl font-bold text-red-600 mb-4">Multi-source Integration</h3>
              <p class="text-gray-300">Aggregating news from multiple trusted sources while maintaining consistent formatting and avoiding duplicate content.</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <section class="pb-16" style="background-color: black;">
      <div class="container mx-auto px-4">
        ...
        <div class="max-w-6xl mx-auto">
          <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div class="bg-gray-900/50 p-6 rounded-lg border border-red-500/20">
              <h3 class="text-xl font-bold mb-4 text-red-600">AI-Powered Curation</h3>
              <p class="text-gray-300">Advanced machine learning algorithms filter and curate news content, ensuring users receive credible and relevant information.</p>
            </div>
            <div class="bg-gray-900/50 p-6 rounded-lg border border-red-500/20">
              <h3 class="text-xl font-bold mb-4 text-red-600">Push Notifications</h3>
              <p class="text-gray-300">Smart notification system delivers breaking news instantly while allowing users to customize their notification preferences.</p>
            </div>
            <div class="bg-gray-900/50 p-6 rounded-lg border border-red-500/20">
              <h3 class="text-xl font-bold mb-4 text-red-600">Offline Reading</h3>
              <p class="text-gray-300">Download articles for offline reading, ensuring users stay informed even without internet connectivity.</p>
            </div>
            <div class="bg-gray-900/50 p-6 rounded-lg border border-red-500/20">
              <h3 class="text-xl font-bold mb-4 text-red-600">Multi-Category Feed</h3>
              <p class="text-gray-300">Organized news categories including politics, sports, technology, entertainment, and local news for easy navigation.</p>
            </div>
          </div>
        </div>
      </div>
