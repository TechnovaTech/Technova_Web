  ...
  <body>
    ...
    <div class="container">
      <div class="row align-items-center justify-content-center project-hero">
        <div class="col-12 col-lg-5 d-flex justify-content-center mb-4 mb-lg-0 me-5 hero-img-side">
          <video class="w-90 rounded" controls>
        <source src="uploads/images/KMBCH.mp4" type="video/mp4">
        ...
        <div class="col-12 col-lg-7 d-flex flex-column align-items-center hero-text-side">
          <div class="glass-notebook-stack w-100">
            ...
            <div class="glass-notebook card-top">
              <h1 class="hero-title text-center">KMBCH - Landing page 3D & motion for a beverage brand </h1>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="row justify-content-center g-4">
      ...
      <div class="col-12 col-md-6 col-lg-5 mb-4 mx-auto">
        <div class="glass-card animated-card slide-in-left">
          <div class="p-4">
            <h3 class="card-title mb-4">About Project</h3>
            <ul class="card-text" style="list-style-type: square;">
             <li><strong>Branding -</strong> Logo, labels, packaging, brandbook</li>
             <li><strong>Illustration - </strong>Custom label pattern</li>
             <li><strong>UI/UX -</strong> Landing page and Responsive</li>
             <li><strong>3D motion  -</strong> Bottle and Packaging 3d render</li>
             <li><strong>Product Photography - </strong>Content creation</li>
             <li><strong>Development -</strong> Made in Webflow</li>
            </ul>
          </div>
        </div>
      </div>
      ...
      <div class="col-12 col-md-6 col-lg-5 mb-4 mx-auto">
        <div class="glass-card animated-card slide-in-right">
          <div class="p-4">
            ...
            <p>
                In the brand book, we have collected all the essential points regarding the use of the logo, its types and colors, and the rules for placement on various backgrounds.We also collected all the colors and fonts of
                the brand and their hierarchy and showed how to work with them within the framework of the KMBCh brand identity.
            </p>
          </div>
        </div>
      </div>
