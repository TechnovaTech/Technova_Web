...
<div class="hidden" id="main-content">
 ...
 <!-- Header/Navigation -->
    ...
    <div class="container">
      <div class="row align-items-center justify-content-center project-hero">
        <div class="col-12 col-lg-5 d-flex justify-content-center mb-4 mb-lg-0 hero-img-side">
          <img src="uploads/images/pp1.webp" alt="Project Main" class="img-fluid" />
        </div>
        <div class="col-12 col-lg-7 d-flex flex-column align-items-center hero-text-side">
          <div class="glass-notebook-stack w-100">
            ...
            <div class="glass-notebook card-top">
              <h1 class="hero-title text-center">Ludo - click, roll, and conquer</h1>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="col-12 col-md-6 col-lg-5 mb-4 mx-auto">
        <div class="glass-card animated-card slide-in-left">
          <div class="p-4">
            ...
            <p>
                Designing the token movement and dice roll synchronization was one of the major challenges. We had to simulate Ludo’s turn-based system, ensure fair randomization, and avoid user conflicts 
                in multiplayer mode. Another technical challenge was enforcing game rules like safe zones and token captures while keeping the UX simple.Handling animations without delays or bugs required careful 
                DOM updates and timer control. If multiplayer was enabled, managing real-time socket communication or database sync added another layer of complexity.
            </p>
          </div>
        </div>
      </div>
        ...
        <div class="glass-card animated-card slide-in-right">
          <div class="p-4">
            ...
            <ul class="card-text" style="list-style-type: square;">
              <li><strong>Turn-Based Multiplayer Logic – </strong> Supports 2 to 4 players with alternating turns.</li>
              <li><srong>Dice Roll Animation –</srong> Realistic dice roll with random number generation.</li>
              <li><strong>Token Movement System – </strong> Token logic with safe zones, start areas, and home paths.</li>
              <li><strong>Game Reset & Restart –</strong>Option to start a new game anytime.</li>
              <li><strong>Responsive Interface – </strong>Fully mobile-friendly layout with drag or click moves.</li>
            </ul>
          </div>
        </div>
      </div>
  ...
  <div class="insight-card mx-auto animated-card pop-in">
    ...
    <p>
    This project sharpened our understanding of real-time logic, state management, and UI interaction flow. We realized the importance of a clean, user-friendly interface to keep players engaged in a turn-based game.
    The balance between visual feedback and fast responsiveness was critical to simulate the feeling of a physical board game.Testing with users gave valuable feedback on frustration points like unclear turns, slow dice, 
    or token confusion — which we fixed with indicators, animations, and clear prompts.
    </p>
  </div>
</section>
...
<section class="container my-5">
  ...
  <div class="row justify-content-center align-items-end">
    <div class="col-6 col-sm-6 col-md-3 mb-3 d-flex justify-content-center">
      <img src="uploads/images/pp2.webp" alt="Design 1" class="creative-img img-fluid">
    </div>
    <div class="col-6 col-sm-6 col-md-3 mb-3 d-flex justify-content-center">
      <img src="uploads/images/pp3.webp" alt="Design 2" class="creative-img img-fluid">
    </div>
    <div class="col-6 col-sm-6 col-md-3 mb-3 d-flex justify-content-center">
      <img src="uploads/images/pp4.webp" alt="Design 3" class="creative-img img-fluid">
    </div>
    <div class="col-6 col-sm-6 col-md-3 mb-3 d-flex justify-content-center">
      <img src="uploads/images/pp5.webp" alt="Design 4" class="creative-img img-fluid">
    </div>
    <div class="col-6 col-sm-6 col-md-3 mb-3 d-flex justify-content-center">
      <img src="uploads/images/pp6.webp" alt="Design 5" class="creative-img img-fluid">
    </div>
  </div>
</section>
