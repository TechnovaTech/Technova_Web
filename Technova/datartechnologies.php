  ...
  <body>
    <section style="background: #000; padding: 100px 0 80px; min-height: 60vh; display: flex; align-items: center;">
      <div class="container text-center">
        ...
        <h1 style="font-size: 2.5rem; font-weight: 700; color: #fff; margin-bottom: 2rem;">Datar Technologies</h1>
        ...
        <p style="max-width: 900px; margin: 0 auto; font-size: 1.1rem; line-height: 1.8; color: #d1d5db;">
          Datar Technologies is a comprehensive technology solutions provider specializing in innovative software development and digital transformation services. The platform delivers cutting-edge solutions across web development, mobile applications, cloud computing, and enterprise systems to empower businesses with modern technology infrastructure.
        </p>
        <div class="swiper mySwiper" style="margin-top: 3rem; width: 90%; height: 400px;">
          <div class="swiper-wrapper">
            <div class="swiper-slide" style="background-image: url('uploads/images/image1.png'); width: 500px; height: 350px; border-radius: 15px; background-position: center; background-size: cover; box-shadow: 0 8px 16px rgba(0,0,0,0.15);"></div>
            <div class="swiper-slide" style="background-image: url('uploads/images/image2.png'); width: 500px; height: 350px; border-radius: 15px; background-position: center; background-size: cover; box-shadow: 0 8px 16px rgba(0,0,0,0.15);"></div>
            <div class="swiper-slide" style="background-image: url('uploads/images/image3.png'); width: 500px; height: 350px; border-radius: 15px; background-position: center; background-size: cover; box-shadow: 0 8px 16px rgba(0,0,0,0.15);"></div>
            <div class="swiper-slide" style="background-image: url('uploads/images/image4.png'); width: 500px; height: 350px; border-radius: 15px; background-position: center; background-size: cover; box-shadow: 0 8px 16px rgba(0,0,0,0.15);"></div>
            <div class="swiper-slide" style="background-image: url('uploads/images/image5.png'); width: 500px; height: 350px; border-radius: 15px; background-position: center; background-size: cover; box-shadow: 0 8px 16px rgba(0,0,0,0.15);"></div>
            <div class="swiper-slide" style="background-image: url('uploads/images/image6.png'); width: 500px; height: 350px; border-radius: 15px; background-position: center; background-size: cover; box-shadow: 0 8px 16px rgba(0,0,0,0.15);"></div>
          </div>
        </div>
      </div>
    </section>
...
<section class="container my-5">
  <div class="row mt-5 pt-5 justify-content-center">
    <div class="col-md-6 mb-4 text-center">
      ...
      <span style="display: inline-block; padding: 10px 24px; border: 2px solid #fff; border-radius: 25px; color: #fff; font-size: 1rem; margin: 5px;">ASP.NET</span>
      <span style="display: inline-block; padding: 10px 24px; border: 2px solid #fff; border-radius: 25px; color: #fff; font-size: 1rem; margin: 5px;">SQL Server</span>
    </div>
    <div class="col-md-6 mb-4 text-center">
      <h3 style="font-size: 1.5rem; font-weight: 600; color: #fff; margin-bottom: 1.5rem;">Industry:</h3>
      <p style="font-size: 1rem; color: #d1d5db; margin: 0;">Technology Solutions</p>
    </div>
  </div>
</section>
