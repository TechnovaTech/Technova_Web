...
<div id="mobile-menu" class="hidden md:hidden absolute top-20 left-0 w-full bg-black bg-opacity-90 backdrop-blur-md shadow-lg">
    ...
    <div class="container mx-auto px-4 sm:px-6 relative z-10">
      <div class="flex flex-col lg:flex-row gap-8 lg:gap-12 items-center">
        <div class="w-full lg:w-1/2 reveal">
          ...
          <h1 class="text-3xl sm:text-4xl md:text-5xl font-bold mb-6">Employee's Attendance System</h1>
          <p class="text-gray-400 text-lg mb-8">
           An Online Employee Attendance System is a web or app-based platform that automates the tracking of employee attendance, working hours, leave requests, and shift management. It eliminates the need for manual records and enables businesses to manage their workforce more efficiently.
          </p>
          <p class="text-gray-400 text-lg mb-8">
              The system typically includes two main interfaces: Admin Panel and Employee Panel, each designed with specific roles and access controls to ensure smooth operations.
          </p>
          <div class="grid grid-cols-2 sm:grid-cols-3 gap-6 mb-8">
            <div>
              <h4 class="text-sm text-gray-500 mb-1">Client</h4>
              <p>Technova Technologies</p>
            </div>
            <div>
              <h4 class="text-sm text-gray-500 mb-1">Category</h4>
              <p>Attendance System, Web Platform</p>
            </div>
            <div>
        ...
        <div class="w-full lg:w-1/2 reveal">
          <img src="https://ubsapp.com/wp-content/uploads/2022/03/attendance_management-copy.png" alt="I Project" class="w-full h-auto rounded-lg shadow-2xl">
        </div>
      </div>
    </div>
  </section>
  ...
  <section id="project-details" class="py-16 md:py-24 bg-black">
    <div class="container mx-auto px-4 sm:px-6">
      <div class="max-w-3xl mx-auto reveal">
        ...
        <h3 class="text-xl font-bold mt-10 mb-4">Admin Panel</h3>
        <p class="text-gray-300 mb-6">
            The Admin Panel is the control center for HR managers, team leads, or system administrators. It provides full access to manage and monitor employee attendance data.
        </p>
        <h5 class=" mt-10 mb-4">Key Features:</h3>
        <ul>
            <li class="ms-5">
                Dashboard overview of daily attendance status.
            </li>
            <li class="ms-5">Add, edit, or remove employee profiles.</li>
            <li class="ms-5">Assign shifts, working hours, and holidays.</li>
            <li class="ms-5">View and approve/reject leave applications.</li>
            <li class="ms-5">Generate and export attendance and payroll reports.</li>
            <li class="ms-5">Manage departments, designations, and user roles.</li>
           
        </ul>
        
         <h3 class="text-xl font-bold mt-10 mb-4">Employee Panel</h3>
        <p class="text-gray-300 mb-6">
            The Employee Panel is a user-friendly interface that allows employees to manage their own attendance and leave records.
        </p>
        <h5 class=" mt-10 mb-4">Key Features:</h3>
        <ul>
            <li class="ms-5">
               Clock in/out via web.
            </li>
            <li class="ms-5">View personal attendance and working hours.</li>
            <li class="ms-5">Apply for leave or check leave balance.</li>
            <li class="ms-5">Receive notifications on leave status and shift changes.</li>
            <li class="ms-5">Access holiday calendar and shift schedule.</li>
            <li class="ms-5">View monthly attendance reports.</li>
        </ul>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 my-8">
          <div class="bg-gray-900/30 p-6 rounded-lg">
            ...
            <p class="text-gray-400">We conducted extensive user interviews and usability testing to understand pain points and expectations.</p>
          </div>
          <div class="bg-gray-900/30 p-6 rounded-lg">
            <div class="w-12 h-12 rounded-full bg-primary/20 flex items-center justify-center mb-4">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 text-primary">
            ...
            <p class="text-gray-400">We simplified the interface, reduced form fields, and added clear guidance at every step.</p>
          </div>
          <div class="bg-gray-900/30 p-6 rounded-lg">
            <div class="w-12 h-12 rounded-full bg-primary/20 flex items-center justify-center mb-4">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 text-primary">
            ...
            <p class="text-gray-400">We built a fully responsive platform with a focus on performance and accessibility.</p>
          </div>
        </div>
  ...
  <div class="gallery-grid max-w-5xl mx-auto mb-12 reveal" id="thumbnailGallery">
    ...
    <img src="uploads/images/p1.jpeg" class="thumb cursor-pointer w-full h-48 object-cover rounded shadow" alt="Image 1" />
    <img src="uploads/images/p2.png" class="thumb cursor-pointer w-full h-48 object-cover rounded shadow" alt="Image 2" />
    <img src="uploads/images/p3.jpeg" class="thumb cursor-pointer w-full h-48 object-cover rounded shadow" alt="Image 3" />
    <img src="uploads/images/p4.jpeg" class="thumb cursor-pointer w-full h-48 object-cover rounded shadow" alt="Image 4" />
    <img src="uploads/images/p5.jpeg" class="thumb cursor-pointer w-full h-48 object-cover rounded shadow" alt="Image 5" />
    <img src="uploads/images/p6.jpeg" class="thumb cursor-pointer w-full h-48 object-cover rounded shadow" alt="Image 6" />
    <img src="uploads/images/p7.jpeg" class="thumb cursor-pointer w-full h-48 object-cover rounded shadow" alt="Image 7" />
    <img src="uploads/images/p8.jpeg" class="thumb cursor-pointer w-full h-48 object-cover rounded shadow" alt="Image 8" />
    <img src="uploads/images/p9.jpeg" class="thumb cursor-pointer w-full h-48 object-cover rounded shadow" alt="Image 9" />
  </div>
    ...
    <div class="flex-1 overflow-x-auto px-4 py-2">
      ...
      <div class="max-w-3xl mx-auto reveal">
        ...
        <ul class="list-disc list-inside space-y-2 text-gray-300 mb-8">
          <li>45% increase in online conversion rates</li>
          <li>50% reduction in abandonment during quote process</li>
          <li>35% decrease in customer support calls</li>
          <li>62% increase in mobile engagement</li>
          <li>28% improvement in average customer satisfaction scores</li>
        </ul>
