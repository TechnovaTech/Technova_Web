    ...
    <section class="pt-32 pb-20 relative overflow-hidden">
        ...
        <div class="container mx-auto px-6 lg:px-12 xl:px-20 relative z-10">
            <div class="text-center max-w-6xl mx-auto">
                ...
                <p class="text-xl sm:text-2xl text-gray-300 max-w-4xl mx-auto leading-relaxed">Transform your business with custom web applications, responsive websites, and scalable solutions built with cutting-edge technologies. We deliver high-performance web experiences that drive growth and engagement.</p>
            </div>
        </div>
    </section>
