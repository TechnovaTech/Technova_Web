...
if(isset($_POST['update_slider']))
{
  ...
  $new_data = array();
  $targent_folder ="uploads/sliders/";
  ...
  $table_name = "slider";
   ...
   $result = update_records_by_id($table_name,$new_data,$slider_id);
   if($result==1)
   {
    ?>
            ...
            <form role="form" method="post" action="#" enctype="multipart/form-data">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="title" class="form-control" id="slidertext" placeholder="Enter Title" required="" value="<?php echo $data['title'] ?>">
                </div>

                <div class="form-group">
                  <label for="slidertext">Slider Text</label>
                  <input type="text" name="text" class="form-control" id="slidertext" placeholder="Enter text" required="" value="<?php echo $data['text'] ?>">
                </div>

                 <div>
                  <label>Image 1 Preview</label><br>
                  <img  src="<?php echo $config["app_url"];?>uploads/sliders/<?php echo $data['image'];?>"  height="200px" max-width="100%" class="img-preview" >
                </div>
              ...
              <div class="box-footer">
                <button type="submit" name="update_slider" class="btn btn-primary">Submit</button>
              </div>
            </form>
            </div>
            <!-- /.box-body -->
