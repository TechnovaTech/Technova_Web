    ...
    <div class="container">
      <div class="row align-items-center justify-content-center project-hero">
        <div class="col-12 col-lg-5 d-flex justify-content-center mb-4 mb-lg-0 hero-img-side">
          <img src="uploads/images/codefly.webp" alt="Project Main" class="img-fluid" />
        </div>
        <div class="col-12 col-lg-7 d-flex flex-column align-items-center hero-text-side">
          <div class="glass-notebook-stack w-100">
            ...
            <div class="glass-notebook card-top">
              <h1 class="hero-title text-center">Codefly : Logo Design</h1>
            </div>
          </div>
        </div>
      </div>
  ...
  <section class="container my-5 ">
    <div class="row justify-content-center g-4">
      <div class="col-12 col-md-6 col-lg-5 mb-4 mx-auto">
        <div class="animated-card slide-in-left">
          <div class="p-4">
            <h3 class="card-title mb-4">Technologies</h3>
                <p>
                        <span class="badge  text-light border rounded-pill me-2" style="padding: 16px; font-size: 1rem;">Illustrator</span>
                        <span class="badge  text-light border rounded-pill me-2" style="padding: 16px; font-size: 1rem;">Photoshop</span>
                        <span class="badge  text-light border rounded-pill me-2" style="padding: 16px; font-size: 1rem;">Canva</span>
                        <span class="badge  text-light border rounded-pill me-2" style="padding: 16px; font-size: 1rem;">Figma</span>
                </p>
          </div>
        </div>
      </div>
      <div class="col-12 col-md-6 col-lg-5 mb-4 mx-auto">
        <div class=" animated-card slide-in-right">
          <div class="p-4">
            <h3 class="card-title mb-4">Industry </h3>
                <p class="text-center">Learner</p>
          </div>
        </div>
      </div>
    </div>
