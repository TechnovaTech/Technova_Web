  ...
  <body>
    <section style="background: #000; padding: 100px 0 80px; min-height: 60vh; display: flex; align-items: center;">
      <div class="container text-center">
        ...
        <h1 style="font-size: 2.5rem; font-weight: 700; color: #fff; margin-bottom: 2rem;">Fashion POS ERP</h1>
        ...
        <p style="max-width: 900px; margin: 0 auto; font-size: 1.1rem; line-height: 1.8; color: #d1d5db;">
          Fashion POS ERP is a specialized retail management system designed for fashion businesses. The platform integrates point-of-sale operations, inventory control, sales tracking, customer management, and multi-store operations to deliver streamlined retail excellence and enhanced business performance.
        </p>
        <div class="swiper mySwiper" style="margin-top: 3rem; width: 90%; height: 400px;">
          <div class="swiper-wrapper">
            <div class="swiper-slide" style="background-image: url('uploads/images/Dashboard9.jpeg'); width: 500px; height: 350px; border-radius: 15px; background-position: center; background-size: cover; box-shadow: 0 8px 16px rgba(0,0,0,0.15);"></div>
            <div class="swiper-slide" style="background-image: url('uploads/images/Dashboard10.jpeg'); width: 500px; height: 350px; border-radius: 15px; background-position: center; background-size: cover; box-shadow: 0 8px 16px rgba(0,0,0,0.15);"></div>
            <div class="swiper-slide" style="background-image: url('uploads/images/Dashboard11.jpeg'); width: 500px; height: 350px; border-radius: 15px; background-position: center; background-size: cover; box-shadow: 0 8px 16px rgba(0,0,0,0.15);"></div>
            <div class="swiper-slide" style="background-image: url('uploads/images/Dashboard12.jpeg'); width: 500px; height: 350px; border-radius: 15px; background-position: center; background-size: cover; box-shadow: 0 8px 16px rgba(0,0,0,0.15);"></div>
            <div class="swiper-slide" style="background-image: url('uploads/images/Dashboard13.jpeg'); width: 500px; height: 350px; border-radius: 15px; background-position: center; background-size: cover; box-shadow: 0 8px 16px rgba(0,0,0,0.15);"></div>
            <div class="swiper-slide" style="background-image: url('uploads/images/Dashboard14.jpeg'); width: 500px; height: 350px; border-radius: 15px; background-position: center; background-size: cover; box-shadow: 0 8px 16px rgba(0,0,0,0.15);"></div>
          </div>
        </div>
      </div>
    </section>
...
<section class="container my-5">
  <div class="row mt-5 pt-5 justify-content-center">
    ...
    <div class="col-md-6 mb-4 text-center">
      ...
      <p style="font-size: 1rem; color: #d1d5db; margin: 0;">Fashion Retail</p>
    </div>
  </div>
</section>
