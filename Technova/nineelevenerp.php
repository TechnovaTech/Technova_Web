...
.scroll-container.auto-scroll .scroll-item {
...
<div class="hidden" id="main-content">
 ...
 <!-- Header/Navigation -->
  ...
  <body>
    <section style="background: #000; padding: 100px 0 80px; min-height: 60vh; display: flex; align-items: center;">
      <div class="container text-center">
        <div style="margin-bottom: 2rem;">
          <svg width="60" height="60" viewBox="0 0 24 24" fill="none" stroke="#e11d48" stroke-width="2" style="margin: 0 auto;">
            <path d="M12 2L2 7l10 5 10-5-10-5z"/>
            <path d="M2 17l10 5 10-5"/>
            <path d="M2 12l10 5 10-5"/>
          </svg>
        </div>
        <h1 style="font-size: 2.5rem; font-weight: 700; color: #fff; margin-bottom: 2rem;">9-ELEVEN WRAP ERP</h1>
        <div style="width: 100%; max-width: 900px; margin: 0 auto 2rem; height: 1px; background: linear-gradient(to right, transparent, #4b5563, transparent);"></div>
        <p style="max-width: 900px; margin: 0 auto; font-size: 1.1rem; line-height: 1.8; color: #d1d5db;">
          9-ELEVEN WRAP ERP is a comprehensive enterprise resource planning solution designed for manufacturing and logistics businesses. The system integrates inventory management, production planning, order processing, and real-time reporting to streamline operations and enhance productivity across all business functions.
        </p>
        <div class="swiper mySwiper" style="margin-top: 3rem; width: 90%; height: 400px;">
          <div class="swiper-wrapper">
            <div class="swiper-slide" style="background-image: url('uploads/images/Dashboard3.png'); width: 500px; height: 350px; border-radius: 15px; background-position: center; background-size: cover; box-shadow: 0 8px 16px rgba(0,0,0,0.15);"></div>
            <div class="swiper-slide" style="background-image: url('uploads/images/Dashboard4.png'); width: 500px; height: 350px; border-radius: 15px; background-position: center; background-size: cover; box-shadow: 0 8px 16px rgba(0,0,0,0.15);"></div>
            <div class="swiper-slide" style="background-image: url('uploads/images/Dashboard5.png'); width: 500px; height: 350px; border-radius: 15px; background-position: center; background-size: cover; box-shadow: 0 8px 16px rgba(0,0,0,0.15);"></div>
            <div class="swiper-slide" style="background-image: url('uploads/images/Dashboard6.png'); width: 500px; height: 350px; border-radius: 15px; background-position: center; background-size: cover; box-shadow: 0 8px 16px rgba(0,0,0,0.15);"></div>
            <div class="swiper-slide" style="background-image: url('uploads/images/Dashboard7.png'); width: 500px; height: 350px; border-radius: 15px; background-position: center; background-size: cover; box-shadow: 0 8px 16px rgba(0,0,0,0.15);"></div>
            <div class="swiper-slide" style="background-image: url('uploads/images/Dashboard8.png'); width: 500px; height: 350px; border-radius: 15px; background-position: center; background-size: cover; box-shadow: 0 8px 16px rgba(0,0,0,0.15);"></div>
          </div>
        </div>
      </div>
    </section>
...
<section class="container my-5">
  <div class="row mt-5 pt-5 justify-content-center">
    ...
    <div class="col-md-6 mb-4 text-center">
      <h3 style="font-size: 1.5rem; font-weight: 600; color: #fff; margin-bottom: 1.5rem;">Technologies used:</h3>
      <span style="display: inline-block; padding: 10px 24px; border: 2px solid #fff; border-radius: 25px; color: #fff; font-size: 1rem; margin: 5px;">Next.js</span>
      <span style="display: inline-block; padding: 10px 24px; border: 2px solid #fff; border-radius: 25px; color: #fff; font-size: 1rem; margin: 5px;">MongoDB</span>
    </div>
    <div class="col-md-6 mb-4 text-center">
      <h3 style="font-size: 1.5rem; font-weight: 600; color: #fff; margin-bottom: 1.5rem;">Industry:</h3>
      <p style="font-size: 1rem; color: #d1d5db; margin: 0;">Manufacturing & Logistics</p>
    </div>
  </div>
</section>
 ...
 <footer class="bg-black text-grey py-12 sm:py-16 border-t border-gray-800">
  ...
  function startAutoScroll() {
    ...
    autoScrollInterval = setInterval(() => {
      if (carousel.scrollLeft >= carousel.scrollWidth - carousel.clientWidth) {
        ...
        carousel.scrollBy({ left: 515, behavior: 'smooth' });
      }
    }, 1000);
  }
  ...
  document.getElementById('designCarousel').addEventListener('mouseenter', stopAutoScroll);
  document.getElementById('designCarousel').addEventListener('mouseleave', startAutoScroll);
