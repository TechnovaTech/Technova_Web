...
<div class="hidden" id="main-content">
 ...
 <!-- Header/Navigation -->
    ...
    <div class="container">
      <div class="row align-items-center justify-content-center project-hero">
        <div class="col-12 col-lg-5 d-flex justify-content-center mb-4 mb-lg-0 hero-img-side">
          <img src="uploads/images/p1.webp" alt="Project Main" class="img-fluid" />
        </div>
        <div class="col-12 col-lg-7 d-flex flex-column align-items-center hero-text-side">
          <div class="glass-notebook-stack w-100">
            ...
            <div class="glass-notebook card-top">
              <h1 class="hero-title text-center">FOODGASM Order Management System</h1>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="glass-card animated-card slide-in-left">
          <div class="p-4">
            ...
            <ul class="card-text" style="list-style-type: square;">
              ...
              <li>Speed Optimization with High Media Usage</li>
              <li>Mobile Performance Tuning</li>
              <li>Custom Cart Logic for Perishable Goods</li>
              <li>Analytics Dashboard</li>
              <li>Third-Party API Integration Issues</li>
      ...
      <div class="col-12 col-md-6 col-lg-5 mb-4 mx-auto">
        <div class="glass-card animated-card slide-in-right">
          <div class="p-4">
            ...
            <ul class="card-text" style="list-style-type: square;">
              <li>User Retention Depends on Speed and Simplicity: Streamlined the checkout flow from 6 steps to 3, reducing bounce rates.</li>
              <li><strong>Localized UX Drives Conversions:</strong> Offering language and regional pricing options increased engagement in Tier 2 cities.</li>
              <li><srong>Scalability Matters Early:</srong> Modular design helped in adding subscription plans and bulk order options later without rewriting core code.</li>
              <li><strong>Feedback Loop is Crucial:</strong> Implementing customer reviews helped identify top-selling products and customer pain points.</li>
            </ul>
          </div>
        </div>
      </div>
  ...
  <div class="insight-card mx-auto animated-card pop-in">
    ...
    <p>
     This project is a fully functional food e-commerce platform designed to simplify the online buying experience for groceries, snacks, and ready-to-eat meals. The website enables customers to browse a wide variety of food item
     , place orders with ease, and get them delivered to their doorstep.
     Built with a focus on usability, performance, and scalability, the platform serves both individual customers and bulk buyers like restaurants and caterers. It supports features like real-time stock updates, location-based delivery, secure payments, and order tracking — providing a seamless and user-friendly shopping experience.
    </p>
  </div>
</section>
...
<section class="container my-5">
  ...
  <div class="row justify-content-center align-items-end">
    <div class="col-6 col-sm-6 col-md-3 mb-3 d-flex justify-content-center">
      <img src="uploads/images/p2.webp" alt="Design 1" class="creative-img img-fluid">
    </div>
    <div class="col-6 col-sm-6 col-md-3 mb-3 d-flex justify-content-center">
      <img src="uploads/images/p3.webp" alt="Design 2" class="creative-img img-fluid">
    </div>
    <div class="col-6 col-sm-6 col-md-3 mb-3 d-flex justify-content-center">
      <img src="uploads/images/p4.webp" alt="Design 3" class="creative-img img-fluid">
    </div>
    <div class="col-6 col-sm-6 col-md-3 mb-3 d-flex justify-content-center">
      <img src="uploads/images/p5.webp" alt="Design 4" class="creative-img img-fluid">
    </div>
    <div class="col-6 col-sm-6 col-md-3 mb-3 d-flex justify-content-center">
      <img src="uploads/images/p6.webp" alt="Design 5" class="creative-img img-fluid">
    </div>
    <div class="col-6 col-sm-6 col-md-3 mb-3 d-flex justify-content-center">
      <img src="uploads/images/p7.webp" alt="Design 6" class="creative-img img-fluid">
    </div>
    <div class="col-6 col-sm-6 col-md-3 mb-3 d-flex justify-content-center">
      <img src="uploads/images/p8.webp" alt="Design 7" class="creative-img img-fluid">
    </div>
  </div>
</section>
