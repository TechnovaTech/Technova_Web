...
<section id="hire-team" class="pt-24 sm:pt-28 py-16 sm:py-22 relative overflow-hidden">
    <div class="absolute inset-0" style="background: linear-gradient(to right, rgba(225, 29, 72, 0.05), transparent);"></div>
    <div class="container mx-auto px-4 sm:px-6 relative z-10">
      <div class="mb-12 sm:mb-16 reveal">
        <h2 class="text-2xl sm:text-3xl font-bold mb-4">STAFF AUGMENTATION</h2>
        <p class="text-gray-400 max-w-2xl">Enhance your team with our skilled professionals who integrate seamlessly with your existing workflow.</p>
      </div>

      <div class="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
        <div class="p-6 bg-gray-900/50 rounded-lg hover:bg-gray-900 transition-all duration-500 transform hover:-translate-y-2 hover:shadow-xl hover:shadow-primary/10 reveal tilt" style="transition-delay: 100ms;">
          ...
          <h3 class="text-xl font-medium mb-4">Dedicated Development Team</h3>
          <p class="text-gray-400">
            Augment your in-house capabilities with our skilled professionals who integrate seamlessly with your team.
          </p>
          <ul class="space-y-2 my-4">
            ...
            <li class="flex items-center gap-2 text-sm text-gray-400">
              <span class="w-1 h-1 bg-primary rounded-full"></span>
              <span>DevOps professionals</span>
            </li>
            <li class="flex items-center gap-2 text-sm text-gray-400">
              <span class="w-1 h-1 bg-primary rounded-full"></span>
          ...
          <a href="contact.php" class="btn mt-4 inline-flex items-center">
            Hire a Team
        ...
        <div class="p-6 bg-gray-900/50 rounded-lg hover:bg-gray-900 transition-all duration-500 transform hover:-translate-y-2 hover:shadow-xl hover:shadow-primary/10 reveal tilt" style="transition-delay: 200ms;">
          <div class="w-14 h-14 sm:w-16 sm:h-16 rounded-full bg-primary/20 flex items-center justify-center mb-4">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-7 w-7 sm:h-8 sm:w-8 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
              <path stroke-linecap="round" stroke-linejoin="round" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
            </svg>
          </div>
          <h3 class="text-xl font-medium mb-4">Hire Individual Developers</h3>
          <p class="text-gray-400">
            Access specialized talent for specific project needs without the overhead of full-time hiring.
          </p>
          <ul class="space-y-2 my-4">
            <li class="flex items-center gap-2 text-sm text-gray-400">
              <span class="w-1 h-1 bg-primary rounded-full"></span>
