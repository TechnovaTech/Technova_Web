...
<div id="mobile-menu" class="hidden md:hidden absolute top-20 left-0 w-full bg-black bg-opacity-90 backdrop-blur-md shadow-lg">
  ...
  <!-- Services Section -->
  <section id="technologies" class="pt-32 pb-16 sm:pt-36 sm:pb-20 bg-black">
    <div class="container mx-auto px-4 sm:px-6">
      <div class="mb-12 text-center">
        <h2 class="text-5xl sm:text-6xl font-bold mb-4 text-white"><span class="text-primary">Our</span> Services</h2>
        <p class="text-gray-300 max-w-3xl mx-auto text-lg">As we've evolved, we've coded a culture that thrives and it's purely replicable in all our offered services. It's just like a simple plain vanilla; right from the start of ideation to the end of delivery, our champions are on their toes to deliver you the best.</p>
      </div>

      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
        <div class="bg-black border-2 border-primary rounded-lg p-8 hover:shadow-2xl hover:shadow-primary/20 transition-all duration-300">
        ...
        <div class="bg-black border-2 border-primary rounded-lg p-8 hover:shadow-2xl hover:shadow-primary/20 transition-all duration-300">
          <h3 class="text-2xl font-bold mb-4 text-white">Mobile Development</h3>
          <ul class="space-y-2 text-white">
        ...
        <div class="bg-black border-2 border-primary rounded-lg p-8 hover:shadow-2xl hover:shadow-primary/20 transition-all duration-300">
          <h3 class="text-2xl font-bold mb-4 text-white">Cloud Services</h3>
          <ul class="space-y-2 text-white">
        ...
        <div class="bg-black border-2 border-primary rounded-lg p-8 hover:shadow-2xl hover:shadow-primary/20 transition-all duration-300">
          <h3 class="text-2xl font-bold mb-4 text-white">AI Capabilities</h3>
          <ul class="space-y-2 text-white">
      ...
      <div class="text-center">
        <a href="portfolio.php" class="inline-block border-2 border-white text-white px-8 py-3 text-lg font-semibold hover:bg-white hover:text-black transition-all duration-300">SEE PROJECTS</a>
      </div>
    </div>
  </section>

  <!-- Technology Services Section -->
  <section class="py-16 sm:py-20 bg-white hidden">
    <div class="container mx-auto px-4 sm:px-6">
      <div class="mb-12 text-center">
        <h2 class="text-3xl sm:text-4xl font-bold mb-4 text-black">Our Technologies</h2>
        <p class="text-gray-700 max-w-2xl mx-auto">Explore our comprehensive technology stack and discover how we can transform your business</p>
      </div>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-1">
          <div class="bg-gray-100 rounded-lg p-6 sticky top-24">
            <h3 class="text-xl font-bold mb-6 text-black">Technology Stack</h3>
            <div class="space-y-2">
              <button onclick="showTechInfo('web')" class="tech-menu-item w-full text-left px-4 py-3 rounded-lg transition-all duration-300 hover:bg-primary/20 hover:text-primary text-gray-700" data-tech="web">
              ...
              <button onclick="showTechInfo('mobile')" class="tech-menu-item w-full text-left px-4 py-3 rounded-lg transition-all duration-300 hover:bg-primary/20 hover:text-primary text-gray-700" data-tech="mobile">
                <div class="flex items-center gap-3">
                  <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <button onclick="showTechInfo('ecommerce')" class="tech-menu-item w-full text-left px-4 py-3 rounded-lg transition-all duration-300 hover:bg-primary/20 hover:text-primary text-gray-700" data-tech="ecommerce">
                <div class="flex items-center gap-3">
                  <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <button onclick="showTechInfo('design')" class="tech-menu-item w-full text-left px-4 py-3 rounded-lg transition-all duration-300 hover:bg-primary/20 hover:text-primary text-gray-700" data-tech="design">
                <div class="flex items-center gap-3">
                  <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <button onclick="showTechInfo('cloud')" class="tech-menu-item w-full text-left px-4 py-3 rounded-lg transition-all duration-300 hover:bg-primary/20 hover:text-primary text-gray-700" data-tech="cloud">
                <div class="flex items-center gap-3">
                  <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <button onclick="showTechInfo('ai')" class="tech-menu-item w-full text-left px-4 py-3 rounded-lg transition-all duration-300 hover:bg-primary/20 hover:text-primary text-gray-700" data-tech="ai">
                <div class="flex items-center gap-3">
                  <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="lg:col-span-2">
          <div id="tech-details" class="bg-gray-900/30 rounded-lg p-8 min-h-[500px]">
            ...
            <div id="cloud-details" class="tech-details hidden">
              ...
              <a href="cloud-solutions.php" class="btn-primary px-6 py-3 rounded-lg hover:bg-primary/80 transition-colors duration-300 inline-block text-white no-underline">
                Read More
              </a>
            </div>
            ...
            <div id="ai-details" class="tech-details hidden">
              ...
              <a href="ai-ml-solutions.php" class="btn-primary px-6 py-3 rounded-lg hover:bg-primary/80 transition-colors duration-300 inline-block text-white no-underline">
                Read More
              </a>
            </div>
          </div>
