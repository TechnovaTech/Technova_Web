  ...
  <body>
    <section style="background: #000; padding: 100px 0 80px; min-height: 60vh; display: flex; align-items: center;">
      <div class="container text-center">
        ...
        <h1 style="font-size: 2.5rem; font-weight: 700; color: #fff; margin-bottom: 2rem;">ShopCart</h1>
        ...
        <p style="max-width: 900px; margin: 0 auto; font-size: 1.1rem; line-height: 1.8; color: #d1d5db;">
          A vision built on experience and fueled by passion—ShopCart ECommerce Solution stands as a testament to expertise in online shopping solutions. Our website design captures the company's journey from a skilled developer's ambition to a trusted industry leader. With a seamless and modern interface, the design reflects ShopCart's commitment to efficiency, reliability, and innovation in ecommerce operations.
        </p>
        <div class="swiper mySwiper" style="margin-top: 3rem; width: 90%; height: 400px;">
          <div class="swiper-wrapper">
            <div class="swiper-slide" style="background-image: url('uploads/images/e-commerce1.webp'); width: 500px; height: 350px; border-radius: 15px; background-position: center; background-size: cover; box-shadow: 0 8px 16px rgba(0,0,0,0.15);"></div>
            <div class="swiper-slide" style="background-image: url('uploads/images/e-commerce2.webp'); width: 500px; height: 350px; border-radius: 15px; background-position: center; background-size: cover; box-shadow: 0 8px 16px rgba(0,0,0,0.15);"></div>
            <div class="swiper-slide" style="background-image: url('uploads/images/e-commerce3.webp'); width: 500px; height: 350px; border-radius: 15px; background-position: center; background-size: cover; box-shadow: 0 8px 16px rgba(0,0,0,0.15);"></div>
            <div class="swiper-slide" style="background-image: url('uploads/images/e-commerce1.webp'); width: 500px; height: 350px; border-radius: 15px; background-position: center; background-size: cover; box-shadow: 0 8px 16px rgba(0,0,0,0.15);"></div>
            <div class="swiper-slide" style="background-image: url('uploads/images/e-commerce2.webp'); width: 500px; height: 350px; border-radius: 15px; background-position: center; background-size: cover; box-shadow: 0 8px 16px rgba(0,0,0,0.15);"></div>
            <div class="swiper-slide" style="background-image: url('uploads/images/e-commerce3.webp'); width: 500px; height: 350px; border-radius: 15px; background-position: center; background-size: cover; box-shadow: 0 8px 16px rgba(0,0,0,0.15);"></div>
          </div>
...
<section class="container my-5">
  <div class="row mt-5 pt-5 justify-content-center">
    <div class="col-md-6 mb-4 text-center">
      ...
      <span style="display: inline-block; padding: 10px 24px; border: 2px solid #fff; border-radius: 25px; color: #fff; font-size: 1rem; margin: 5px;">React</span>
      <span style="display: inline-block; padding: 10px 24px; border: 2px solid #fff; border-radius: 25px; color: #fff; font-size: 1rem; margin: 5px;">Node.js</span>
    </div>
    <div class="col-md-6 mb-4 text-center">
      <h3 style="font-size: 1.5rem; font-weight: 600; color: #fff; margin-bottom: 1.5rem;">Industry:</h3>
      <p style="font-size: 1rem; color: #d1d5db; margin: 0;">E-commerce</p>
    </div>
  </div>
</section>
