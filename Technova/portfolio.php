    ...
    <div class="container mx-auto px-4 sm:px-6 relative z-10">
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div class="text-center lg:text-left mx-auto">
          ...
          <div class="w-24 h-1 bg-primary mb-6 mx-auto lg:mx-0"></div>
        ...
        <div class="relative h-96 w-full max-w-lg mx-auto lg:me-auto hidden lg:block">
...
<section id="portfolio" class="pt-24 sm:pt-28 py-16 sm:py-22 relative overflow-hidden">
    <div class="container mx-auto px-4 sm:px-6 lg:px-12 xl:px-20">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        <div class="group bg-gray-900/50 rounded-xl overflow-hidden border border-gray-800 hover:border-primary/50 transition-all duration-300 hover:shadow-2xl hover:shadow-primary/10 reveal" style="transition-delay: 200ms;">
          ...
          <div class="p-6">
            ...
            <p class="text-gray-300 text-sm mb-4 leading-relaxed" style="display: -webkit-box; -webkit-line-clamp: 6; -webkit-box-orient: vertical; overflow: hidden;">A full-featured e-commerce platform designed to convert visitors into customers through seamless shopping experiences, secure payments, and intuitive user interface. Built with modern technologies for optimal performance and scalability.</p>
        ...
        <div class="group bg-gray-900/50 rounded-xl overflow-hidden border border-gray-800 hover:border-primary/50 transition-all duration-300 hover:shadow-2xl hover:shadow-primary/10 reveal" style="transition-delay: 300ms;">
          ...
          <div class="p-6">
            <div class="flex items-center gap-2 mb-3">
              <span class="text-xs bg-primary/20 text-primary px-2 py-1 rounded-full">📊 ERP</span>
              <span class="text-xs bg-gray-700 text-gray-300 px-2 py-1 rounded-full">Enterprise System</span>
            </div>
            ...
            <p class="text-sm text-gray-400 mb-3">Enterprise Resource Planning</p>
            <p class="text-gray-300 text-sm mb-4 leading-relaxed" style="display: -webkit-box; -webkit-line-clamp: 6; -webkit-box-orient: vertical; overflow: hidden;">9-ELEVEN WRAP ERP is a powerful enterprise solution designed for manufacturing and logistics businesses, featuring real-time inventory tracking, production planning, order management, and comprehensive reporting for operational excellence. The system streamlines workflows and enhances productivity across all departments with advanced automation capabilities.</p>
            <div class="flex flex-wrap gap-1 mb-4">
            ...
            <a href="nineelevenerp.php" class="inline-flex items-center text-primary hover:text-white text-sm font-medium transition-colors duration-300">
              View Project
              <svg class="w-4 h-4 ml-1 transition-transform duration-300 group-hover:translate-x-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
              </svg>
        ...
        <div class="group bg-gray-900/50 rounded-xl overflow-hidden border border-gray-800 hover:border-primary/50 transition-all duration-300 hover:shadow-2xl hover:shadow-primary/10 reveal" style="transition-delay: 400ms;">
          <div class="overflow-hidden">
            <img src="uploads/images/Dashboard2.jpeg" alt="FoodGasm" class="w-full h-48 object-cover transition-transform duration-300 group-hover:scale-105">
          </div>
          <div class="p-6">
            <div class="flex items-center gap-2 mb-3">
              <span class="text-xs bg-primary/20 text-primary px-2 py-1 rounded-full">🛒 E-commerce</span>
            ...
            <h3 class="text-xl font-semibold text-white mb-2 group-hover:text-primary transition-colors duration-300">Fashion POS ERP</h3>
            <p class="text-sm text-gray-400 mb-3">Point of Sale & ERP System</p>
            <p class="text-gray-300 text-sm mb-4 leading-relaxed" style="display: -webkit-box; -webkit-line-clamp: 6; -webkit-box-orient: vertical; overflow: hidden;">Fashion POS ERP is a specialized retail management system for fashion businesses, featuring inventory control, sales tracking, customer management, and multi-store operations for streamlined retail excellence.</p>
            <div class="flex flex-wrap gap-1 mb-4">
              <span class="text-xs bg-gray-800 text-gray-400 px-2 py-1 rounded">Next.js</span>
              <span class="text-xs bg-gray-800 text-gray-400 px-2 py-1 rounded">MongoDB</span>
            </div>
            <a href="fashionposerp.php" class="inline-flex items-center text-primary hover:text-white text-sm font-medium transition-colors duration-300">
              View Project
              <svg class="w-4 h-4 ml-1 transition-transform duration-300 group-hover:translate-x-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
              </svg>
        ...
        <!--Card 4-->
        <div class="group bg-gray-900/50 rounded-xl overflow-hidden border border-gray-800 hover:border-primary/50 transition-all duration-300 hover:shadow-2xl hover:shadow-primary/10 reveal" style="transition-delay: 500ms;">
          <div class="overflow-hidden">
            <img src="uploads/images/image4.png" alt="Datartechnologies" class="w-full h-48 object-cover transition-transform duration-300 group-hover:scale-105">
          </div>
          <div class="p-6">
            <div class="flex items-center gap-2 mb-3">
              <span class="text-xs bg-primary/20 text-primary px-2 py-1 rounded-full">📊 ERP</span>
              <span class="text-xs bg-gray-700 text-gray-300 px-2 py-1 rounded-full">SaaS Platform</span>
            </div>
            <h3 class="text-xl font-semibold text-white mb-2 group-hover:text-primary transition-colors duration-300">Datartechnologies</h3>
            <p class="text-sm text-gray-400 mb-3">iOS Software Solution</p>
            <p class="text-gray-300 text-sm mb-4 leading-relaxed" style="display: -webkit-box; -webkit-line-clamp: 6; -webkit-box-orient: vertical; overflow: hidden;">Datartechnologies is a comprehensive iOS software solution designed for modern businesses. The platform delivers seamless mobile experiences with advanced features including real-time data synchronization, intuitive user interfaces, secure authentication, and cloud integration for enhanced productivity and business operations.</p>
            <div class="flex flex-wrap gap-1 mb-4">
              <span class="text-xs bg-gray-800 text-gray-400 px-2 py-1 rounded">ASP.NET</span>
              <span class="text-xs bg-gray-800 text-gray-400 px-2 py-1 rounded">SQL Server</span>
            </div>
            <a href="datartechnologies.php" class="inline-flex items-center text-primary hover:text-white text-sm font-medium transition-colors duration-300">
              View Project
              <svg class="w-4 h-4 ml-1 transition-transform duration-300 group-hover:translate-x-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
              </svg>
