      ...
      <div class="container mx-auto px-4">
        ...
        <div class="overflow-hidden">
          <div class="flex animate-scroll" style="animation: scroll 15s linear infinite;">
            <img src="uploads/images/y0.png" class="w-80 h-60 object-cover rounded-lg mx-4 flex-shrink-0" alt="Yaari App Image 1">
            <img src="uploads/images/y0.png" class="w-80 h-60 object-cover rounded-lg mx-4 flex-shrink-0" alt="Yaari App Image 2">
            <img src="uploads/images/y0.png" class="w-80 h-60 object-cover rounded-lg mx-4 flex-shrink-0" alt="Yaari App Image 3">
            <img src="uploads/images/y0.png" class="w-80 h-60 object-cover rounded-lg mx-4 flex-shrink-0" alt="Yaari App Image 4">
            <img src="uploads/images/y0.png" class="w-80 h-60 object-cover rounded-lg mx-4 flex-shrink-0" alt="Yaari App Image 5">
            <img src="uploads/images/y0.png" class="w-80 h-60 object-cover rounded-lg mx-4 flex-shrink-0" alt="Yaari App Image 6">
            <img src="uploads/images/y0.png" class="w-80 h-60 object-cover rounded-lg mx-4 flex-shrink-0" alt="Yaari App Image 7">
            <img src="uploads/images/y0.png" class="w-80 h-60 object-cover rounded-lg mx-4 flex-shrink-0" alt="Yaari App Image 8">
          </div>
        </div>
      </div>
    </section>
