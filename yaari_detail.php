...
<script>
  ...
  <title>Yaari Dating App - Project Detail</title>
      ...
      <div class="container mx-auto px-4">
        <div class="row align-items-center justify-content-center">
          <div class="col-12 text-center">
            ...
            <!-- Heading -->
            <h1 class="text-4xl sm:text-5xl font-bold text-white mb-4">Yaari Dating App</h1>
            
            <!-- Subtitle -->
            <h2 class="text-2xl sm:text-3xl text-red-600 mb-6">Connect hearts, create memories - Your love story starts here</h2>
            ...
            <div class="mx-auto" style="max-width: 800px;">
              <p class="text-center text-lg text-gray-300 leading-relaxed mb-0">
                A modern dating application designed to help people find meaningful connections with smart matching algorithms, real-time messaging, and video calling features.
              </p>
            </div>
          </div>
        </div>
          ...
          <div class="relative w-full h-80 sm:h-96 md:h-[34rem] mb-6 overflow-hidden">
            <div class="absolute inset-0 flex items-center justify-center">
              <div id="gallery-container" class="flex items-center justify-center h-full transition-transform duration-500 ease-in-out" style="transform: translateX(0px); width: max-content;">
                <img src="uploads/images/y1.png" class="gallery-image w-72 h-80 sm:w-80 sm:h-96 md:w-96 md:h-[30rem] object-contain rounded-lg mx-2 sm:mx-3 md:mx-4 opacity-60 blur-sm transition-all duration-500" alt="Yaari App Screen 1">
                <img src="uploads/images/y2.png" class="gallery-image w-80 h-96 sm:w-96 sm:h-[30rem] md:w-[30rem] md:h-[32rem] object-contain rounded-lg mx-2 sm:mx-3 md:mx-4 opacity-100 blur-0 scale-110 z-10 transition-all duration-500" alt="Yaari App Screen 2">
                <img src="uploads/images/y3.png" class="gallery-image w-72 h-80 sm:w-80 sm:h-96 md:w-96 md:h-[30rem] object-contain rounded-lg mx-2 sm:mx-3 md:mx-4 opacity-60 blur-sm transition-all duration-500" alt="Yaari App Screen 3">
                <img src="uploads/images/y4.png" class="gallery-image w-72 h-80 sm:w-80 sm:h-96 md:w-96 md:h-[30rem] object-contain rounded-lg mx-2 sm:mx-3 md:mx-4 opacity-60 blur-sm transition-all duration-500" alt="Yaari App Screen 4">
                <img src="uploads/images/y5.png" class="gallery-image w-72 h-80 sm:w-80 sm:h-96 md:w-96 md:h-[30rem] object-contain rounded-lg mx-2 sm:mx-3 md:mx-4 opacity-60 blur-sm transition-all duration-500" alt="Yaari App Screen 5">
                <img src="uploads/images/y6.png" class="gallery-image w-72 h-80 sm:w-80 sm:h-96 md:w-96 md:h-[30rem] object-contain rounded-lg mx-2 sm:mx-3 md:mx-4 opacity-60 blur-sm transition-all duration-500" alt="Yaari App Screen 6">
                <img src="uploads/images/y7.png" class="gallery-image w-72 h-80 sm:w-80 sm:h-96 md:w-96 md:h-[30rem] object-contain rounded-lg mx-2 sm:mx-3 md:mx-4 opacity-60 blur-sm transition-all duration-500" alt="Yaari App Screen 7">
                <img src="uploads/images/y8.png" class="gallery-image w-72 h-80 sm:w-80 sm:h-96 md:w-96 md:h-[30rem] object-contain rounded-lg mx-2 sm:mx-3 md:mx-4 opacity-60 blur-sm transition-all duration-500" alt="Yaari App Screen 8">
              </div>
            </div>
        ...
        <div class="max-w-6xl mx-auto">
          <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div class="bg-gray-900/50 p-6 rounded-lg border border-red-500/20">
              <h3 class="text-xl font-bold text-red-600 mb-4">Matching Algorithm</h3>
              <p class="text-gray-300">Developing sophisticated algorithms to match users based on compatibility, interests, and preferences while ensuring privacy.</p>
            </div>
            <div class="bg-gray-900/50 p-6 rounded-lg border border-red-500/20">
              <h3 class="text-xl font-bold text-red-600 mb-4">User Safety</h3>
              <p class="text-gray-300">Implementing robust verification systems and safety features to protect users from fake profiles and inappropriate behavior.</p>
            </div>
            <div class="bg-gray-900/50 p-6 rounded-lg border border-red-500/20">
              <h3 class="text-xl font-bold text-red-600 mb-4">Real-time Communication</h3>
              <p class="text-gray-300">Building seamless messaging and video calling features that work across different devices and network conditions.</p>
            </div>
            <div class="bg-gray-900/50 p-6 rounded-lg border border-red-500/20">
              <h3 class="text-xl font-bold text-red-600 mb-4">User Engagement</h3>
              <p class="text-gray-300">Creating an engaging user experience that encourages meaningful connections while maintaining user retention.</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="max-w-6xl mx-auto bg-gray-900/50 rounded-3xl border border-green-500/30 p-8">
          ...
          <div class="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-8">
            ...
            <div class="text-center">
              ...
              <div class="bg-white rounded-2xl p-6 w-20 h-20 mx-auto flex items-center justify-center mb-3">
                <svg class="w-10 h-10 text-blue-500" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M14.314 0L12 2.828 9.686 0 9.343 9.657 14.314 0zm.343 7.071L12 9.899l-2.657-2.828.343 9.657 2.314-2.828 2.657 2.828-.343-9.657zM0 9.686L2.828 12 0 14.314l9.657.343L0 9.686zm7.071.343L9.899 12l-2.828 2.657 9.657-.343L7.071 10.029zM9.686 24L12 21.172 14.314 24l.343-9.657L9.686 24zm.343-7.071L12 14.101l2.657 2.828-.343-9.657-2.314 2.828-2.657-2.828.343 9.657zM24 14.314L21.172 12 24 9.686l-9.657-.343L24 14.314zm-7.071-.343L14.101 12l2.828-2.657-9.657.343 6.657 4.628z"/>
                </svg>
              </div>
              <p class="text-white font-medium">Flutter</p>
            </div>
            ...
            <div class="text-center">
              ...
              <div class="bg-white rounded-2xl p-6 w-20 h-20 mx-auto flex items-center justify-center mb-3">
                <svg class="w-10 h-10 text-blue-500" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M17.523 15.3414c-.5665 0-.9726-.4061-.9726-.9726 0-.5665.4061-.9726.9726-.9726.5665 0 .9726.4061.9726.9726 0 .5665-.4061.9726-.9726.9726m-5.965 0c-.5665 0-.9726-.4061-.9726-.9726 0-.5665.4061-.9726.9726-.9726.5665 0 .9726.4061.9726.9726 0 .5665-.4061.9726-.9726.9726m-5.965 0c-.5665 0-.9726-.4061-.9726-.9726 0-.5665.4061-.9726.9726-.9726.5665 0 .9726.4061.9726.9726 0 .5665-.4061.9726-.9726.9726M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2z"/>
                </svg>
              </div>
            ...
            <div class="text-center">
              ...
              <div class="bg-white rounded-2xl p-6 w-20 h-20 mx-auto flex items-center justify-center mb-3">
                <svg class="w-10 h-10" viewBox="0 0 24 24" fill="none">
                  <rect x="3" y="3" width="4" height="4" fill="#4DB33D"/>
                  <rect x="10" y="3" width="4" height="4" fill="#4DB33D"/>
                  <rect x="17" y="3" width="4" height="4" fill="#4DB33D"/>
                  <rect x="3" y="10" width="4" height="4" fill="#4DB33D"/>
                  <rect x="10" y="10" width="4" height="4" fill="#4DB33D"/>
                  <rect x="17" y="10" width="4" height="4" fill="#4DB33D"/>
                  <rect x="3" y="17" width="4" height="4" fill="#4DB33D"/>
                  <rect x="10" y="17" width="4" height="4" fill="#4DB33D"/>
                  <rect x="17" y="17" width="4" height="4" fill="#4DB33D"/>
                </svg>
              </div>
    ...
    <section class="pb-16" style="background-color: black;">
      <div class="container mx-auto px-4">
        ...
        <div class="max-w-6xl mx-auto">
          <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div class="bg-gray-900/50 p-6 rounded-lg border border-red-500/20">
              <h3 class="text-xl font-bold mb-4 text-red-600">Smart Matching</h3>
              <p class="text-gray-300">Advanced algorithms analyze user preferences, behavior, and compatibility factors to suggest the most suitable matches.</p>
            </div>
            <div class="bg-gray-900/50 p-6 rounded-lg border border-red-500/20">
              <h3 class="text-xl font-bold mb-4 text-red-600">Secure Messaging</h3>
              <p class="text-gray-300">End-to-end encrypted messaging system with photo sharing, voice messages, and video calling capabilities.</p>
            </div>
            <div class="bg-gray-900/50 p-6 rounded-lg border border-red-500/20">
              <h3 class="text-xl font-bold mb-4 text-red-600">Profile Verification</h3>
              <p class="text-gray-300">Multi-step verification process including photo verification and social media integration to ensure authentic profiles.</p>
            </div>
            <div class="bg-gray-900/50 p-6 rounded-lg border border-red-500/20">
              <h3 class="text-xl font-bold mb-4 text-red-600">Location-Based Matching</h3>
              <p class="text-gray-300">GPS-enabled matching system that connects users based on proximity and location preferences for real-world meetings.</p>
            </div>
          </div>
        </div>
      </div>
