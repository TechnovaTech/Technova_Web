          ...
          <div class="relative w-full h-80 sm:h-96 md:h-[34rem] mb-6 overflow-hidden">
            <div class="absolute inset-0 flex items-center justify-center">
              <div id="gallery-container" class="flex items-center justify-center h-full transition-transform duration-500 ease-in-out" style="transform: translateX(0px); width: max-content;">
                <img src="uploads/images/W3.PNG" class="gallery-image w-72 h-80 sm:w-80 sm:h-96 md:w-96 md:h-[30rem] object-contain rounded-lg mx-2 sm:mx-3 md:mx-4 opacity-60 blur-sm transition-all duration-500" alt="WalkIn FirstPregnancy Image 1">
                <img src="uploads/images/W2.PNG" class="gallery-image w-80 h-96 sm:w-96 sm:h-[30rem] md:w-[30rem] md:h-[32rem] object-contain rounded-lg mx-2 sm:mx-3 md:mx-4 opacity-100 blur-0 scale-110 z-10 transition-all duration-500" alt="WalkIn FirstPregnancy Image 2">
                <img src="uploads/images/w8.PNG" class="gallery-image w-72 h-80 sm:w-80 sm:h-96 md:w-96 md:h-[30rem] object-contain rounded-lg mx-2 sm:mx-3 md:mx-4 opacity-60 blur-sm transition-all duration-500" alt="WalkIn FirstPregnancy Image 3">
                <img src="uploads/images/W5.PNG" class="gallery-image w-72 h-80 sm:w-80 sm:h-96 md:w-96 md:h-[30rem] object-contain rounded-lg mx-2 sm:mx-3 md:mx-4 opacity-60 blur-sm transition-all duration-500" alt="WalkIn FirstPregnancy Image 4">
                <img src="uploads/images/w6.PNG" class="gallery-image w-72 h-80 sm:w-80 sm:h-96 md:w-96 md:h-[30rem] object-contain rounded-lg mx-2 sm:mx-3 md:mx-4 opacity-60 blur-sm transition-all duration-500" alt="WalkIn FirstPregnancy Image 5">
              </div>
            </div>
