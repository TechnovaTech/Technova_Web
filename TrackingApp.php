...
<div class="hidden" id="main-content">
 ...
 <!-- Header/Navigation -->
    ...
    <div class="container">
      <div class="row align-items-center justify-content-center project-hero">
        <div class="col-12 col-lg-5 d-flex justify-content-center mb-4 mb-lg-0 hero-img-side">
          <img src="uploads/images/ppp1.webp" alt="Project Main" class="img-fluid" />
        </div>
        <div class="col-12 col-lg-7 d-flex flex-column align-items-center hero-text-side">
          <div class="glass-notebook-stack w-100">
            ...
            <div class="glass-notebook card-top">
              <h1 class="hero-title text-center">Innovative Activity Tracking App for Personal Growth</h1>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="col-12 col-md-6 col-lg-5 mb-4 mx-auto">
        <div class="glass-card animated-card slide-in-left">
          <div class="p-4">
            ...
            <p class="card-text">
              While most of us set numerous goals in our life, we often fail to stay consistent with the steps that 
              help us achieve those goals. This made us realize the necessity of building a platform that can regularly 
              remind the users of their chosen Habits, Priorities, and Goals. Through A2R we offer a simple yet effective 
              tool to assist you in your personal growth. The platform gives due importance to Personal, Career, and 
              Relationship aspects of your life. In order to ensure a seamless experience for our users, our team faced 
              the challenge of combining a user-friendly interface with a robust set of features. However, with the use 
              of cutting-edge tech stacks and a strong technical architecture, our developers have successfully designed 
              an exceptional product that can help you reach your full potential.
            </p>
          </div>
        </div>
      </div>
        ...
        <div class="glass-card animated-card slide-in-right">
          <div class="p-4">
            ...
            <ul class="card-text" style="list-style-type: square;">
              <li>Users can set Habits, Priorities, and Goals</li>
              <li>Regular Reminders and Push Notifications</li>
              <li>Effective user Activity Tracking Mechanism</li>
              <li>User Reporting System</li>
              <li>Analytics Dashboard</li>
              <li>Automated Performance Report generation</li>
              <li>Goals acknowledgement through Emotions, Evolution, and Evidence</li>
            </ul>
          </div>
        </div>
      </div>
  ...
  <div class="insight-card mx-auto animated-card pop-in">
    ...
    <p>
      At Technova Technologies, we understand the struggle behind setting goals and consistently working 
      towards them. That's why we have created A2R, an amazing platform that helps you stay on track
      with your habits, priorities, and goals. Our app serves as a personal growth tool
      by sending regular reminders and tracking progress in various aspects of your life, including 
      personal, career, and relationship. The platform allows you to set particular messages 
      associated with your chosen activities and goals to remain motivated and assess your 
      progress through an assisted introspection. Moreover, the platform also creates 
        daily, weekly and monthly reports that allows you to continuously assess your progress to stay
...
<section class="container my-5">
  ...
  <div class="row justify-content-center align-items-end">
    <div class="col-6 col-sm-6 col-md-3 mb-3 d-flex justify-content-center">
      <img src="uploads/images/ppp2.webp" alt="Design 1" class="creative-img img-fluid">
    </div>
    <div class="col-6 col-sm-6 col-md-3 mb-3 d-flex justify-content-center">
      <img src="uploads/images/ppp3.webp" alt="Design 2" class="creative-img img-fluid">
    </div>
    <div class="col-6 col-sm-6 col-md-3 mb-3 d-flex justify-content-center">
      <img src="uploads/images/ppp4.webp" alt="Design 3" class="creative-img img-fluid">
    </div>
    <div class="col-6 col-sm-6 col-md-3 mb-3 d-flex justify-content-center">
      <img src="uploads/images/ppp5.webp" alt="Design 4" class="creative-img img-fluid">
    </div>
  </div>
</section>
