...
if(isset($_POST['upload_product']))
{
  ...
  if(move_uploaded_file($tempname1, $targent_folder.$filename1))
  {
    ...
    if($result == 1)
    {
      ...
      <script type="text/javascript">
        alert("Home Content Updated Sucessfully");
      </script>
      <?php
    }
    else
  ...
  ?>
  <script type="text/javascript">
    location.href = "<?php echo $config["app_url"];?>home";
  </script>
  <?php
            ...
            <form role="form" action="#" method="post" enctype="multipart/form-data">
              <div class="box-body">
                ...
                <div>
                  ...
                  <img  src="<?php echo $config["app_url"];?>uploads/home/<?php echo $data['home_image'];?>"  height="200px" max-width="100%" class="img-preview" >
                </div>
