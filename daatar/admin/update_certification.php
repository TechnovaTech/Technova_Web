...
if(isset($_POST['update_certification']))
{
  ...
  $new_data = array();
  $targent_folder ="uploads/certification/";
  ...
  $table_name = "certification";
   ...
   if($result==1)
   {
    ...
    <script type="text/javascript">
      alert("Certification Updated Sucessfully");
    </script>
    <?php
   }else
   {
          ...
          <div class="box">
            ...
            <form role="form" method="post" action="#" enctype="multipart/form-data">
              <div class="box-body">
                <div class="form-group">
                 ...
                 <div>
                  ...
                  <img  src="<?php echo $config["app_url"];?>uploads/products/<?php echo $data['image'];?>"  height="200px" max-width="100%" class="img-preview" >
                </div>
              ...
              <div class="box-footer">
                <button type="submit" name="update_certification" class="btn btn-primary">Submit</button>
              </div>
            </form>
            </div>
            <!-- /.box-body -->
