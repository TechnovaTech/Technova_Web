  ...
  <section class="py-16 sm:py-24 bg-gray-900">
    <div class="container mx-auto px-4 sm:px-6">
      <div class="text-center mb-16">
        <h2 class="text-3xl sm:text-4xl font-bold text-white mb-4">Coming Soon</h2>
        <p class="text-gray-400 max-w-2xl mx-auto">We're working on exciting new products that will revolutionize the way you work. Stay tuned for updates!</p>
      </div>
    </div>
  </section>
